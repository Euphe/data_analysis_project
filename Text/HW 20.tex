...
\footnotesize
    \begin{Verbatim}[commandchars=\\\{\}]    
 \PY{n}{contingency\PYZus{}table\PYZus{}imdb\PYZus{}bodies} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{crosstab}\PY{p}{(}\PY{n}{bodies}\PY{p}{,} \PY{n}{imdb\PYZus{}rating}\PY{p}{,} \PY{n}{margins}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{margins\PYZus{}name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{table}[]
	\begin{tabular}{lllllll}
		IMDB\_Rating  & \textless{}6.0 & $\geq$6.0 & $\geq$7.0 & $\geq$8.0 & Total & Total \\
		Body\_Count   &                &      &      &      &       &       \\
		\textless{}20 & 28             & 65   & 47   & 22   & 162   & 162   \\
		$\geq$120          & 14             & 20   & 44   & 14   & 92    & 92    \\
		$\geq$20           & 28             & 40   & 39   & 23   & 130   & 130   \\
		$\geq$50           & 39             & 49   & 52   & 21   & 161   & 161   \\
		Total         & 109            & 174  & 182  & 80   & 545   & 545  
	\end{tabular}
\end{table}
...
\begin{tabular}{lllll}
	IMDB\_Rating  & \textless{}6.0 & \geq 6.0      & \geq 7.0      & \geq 8.0      \\
	Body\_Count   &                &           &           &           \\
	\textless{}20 & 17.283951      & 40.123457 & 29.012346 & 13.580247 \\
\geq 20           & 21.538462      & 30.769231 & 30.000000 & 17.692308 \\
	\geq 50           & 24.223602      & 30.434783 & 32.298137 & 13.043478 \\
\geq 120          & 15.217391      & 21.739130 & 47.826087 & 15.217391 \\        
\end{tabular}
\\
\normalsize
...
\PY{k}{def} \PY{n+nf}{make\PYZus{}quetelet}\PY{p}{(}\PY{n}{probabilites\PYZus{}df}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{col} \PY{o+ow}{in} \PY{n}{res}\PY{p}{:}
        \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{res}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{o}{.}\PY{n}{index}\PY{p}{:}
            \PY{n}{res}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{p}{[}\PY{n}{row}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{probabilites\PYZus{}df}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{p}{[}\PY{n}{row}\PY{p}{]} \PY{o}{/} \PY{n}{probabilites\PYZus{}df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{n}{row}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{probabilites\PYZus{}df}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PYZbs{}
                \PY{n}{probabilites\PYZus{}df}\PY{p}{[}\PY{n}{col}\PY{p}{]}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{k}{return} \PY{n}{res}
...
make_quetelet(normalize(contingency_table_year_bodies)) * 100
   ...
   \begin{tabular}{lllll}
   	IMDB\_Rating  & \textless{}6.0 & $\geq$6.0       & $\geq$7.0       & $\geq$8.0       \\
   	Body\_Count   &                &            &            &            \\
   	\textless{}20 & -13.580247     & 25.674046  & -13.122371 & -7.484568  \\
   	$\geq$120          & -23.913043     & -31.909045 & 43.215480  & 3.668478   \\
   	$\geq$20           & 7.692308       & -3.625111  & -10.164835 & 20.528846  \\
   	$\geq$50           & 21.118012      & -4.672664  & -3.283052  & -11.141304 \\
   \end{tabular}
...
\PY{n}{degrees\PYZus{}of\PYZus{}freedom\PYZus{}year\PYZus{}bodies} \PY{o}{=} \PY{n}{reduce}\PY{p}{(}\PY{n}{mul}\PY{p}{,} \PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{obs\PYZus{}values\PYZus{}year\PYZus{}bodies}\PY{o}{.}\PY{n}{shape}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
...
\footnotesize \begin{tabular}{llllll}
	Year          & \textless{}1980 & $\geq$1980 & $\geq$1990 & $\geq$2000 & $\geq$2005 \\
	Body\_Count   &                 &       &       &       &       \\
	\textless{}20 & 12              & 14    & 39    & 44    & 53    \\
	$\geq$120          & 20              & 10    & 13    & 24    & 25    \\
	$\geq$20           & 10              & 23    & 48    & 19    & 30    \\
	$\geq$50           & 23              & 25    & 39    & 30    & 44    \\
\end{tabular} \normalsize
\footnotesize \begin{tabular}{llllll}
	Year          & \textless{}1980 & $\geq$1980     & $\geq$1990     & $\geq$2000     & $\geq$2005     \\
	Body\_Count   &                 &           &           &           &           \\
	\textless{}20 & 19.321101       & 21.401835 & 41.317431 & 34.777982 & 45.181651 \\
	$\geq$120          & 10.972477       & 12.154128 & 23.464220 & 19.750459 & 25.658716 \\
	$\geq$20           & 15.504587       & 17.174312 & 33.155963 & 27.908257 & 36.256881 \\
	$\geq$50           & 19.201835       & 21.269725 & 41.062385 & 34.563303 & 44.902752 \\
\end{tabular} \normalsize

The obtained degree of freedom for $\chi^2$ test is 12.

The $\chi^2$ test for the hypothesis of independence between the year and number of bodies:

    \footnotesize \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}184}]:} \PY{n}{scipy}\PY{o}{.}\PY{n}{stats}\PY{o}{.}\PY{n}{chisquare}\PY{p}{(}\PY{n}{trunc\PYZus{}total}\PY{p}{(}\PY{n}{contingency\PYZus{}table\PYZus{}year\PYZus{}bodies}\PY{p}{)}\PY{p}{,} \PY{n}{expected\PYZus{}values}\PY{p}{(}\PY{n}{contingency\PYZus{}table\PYZus{}year\PYZus{}bodies}\PY{p}{)}\PY{p}{,}
\PY{n}{ddof}\PY{o}{=}\PY{n}{ddof\PYZus{}year\PYZus{}bodies}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}
\end{Verbatim} 
\normalsize
...
\end{tabular}
 \normalsize
\footnotesize \begin{tabular}{lllll}
	MDB\_Rating   & \textless{}6.0 & $\geq$6.0      & $\geq$7.0      & $\geq$8.0      \\
	Body\_Count   &                &           &           &           \\
	\textless{}20 & 32.4           & 51.721101 & 54.099083 & 23.779817 \\
	$\geq$120          & 18.4           & 29.372477 & 30.722936 & 13.504587 \\
	$\geq$20           & 26.0           & 41.504587 & 43.412844 & 19.082569 \\
	$\geq$50           & 32.2           & 51.401835 & 53.765138 & 23.633028 \\
\end{tabular}
 \normalsize
...
First we apply PCA and inspect the data scatter explained by each PC. We apply PCA to data centered and normalized by range, as proper PCA application requires data to be on the same scale. The 	
supplementary functions may be found in the Applications.
...
\end{Verbatim} 
 \normalsize
    ...
    The results of the application of principal components are the following.
   The contributions of the components to the explanation of the variance in distribution are:
...
\end{Verbatim} 
 \normalsize
    ...
    \begin{center}
	\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_10_2_4.png}
\end{center}    
...
Next we Applying PCA to data normalized by standard deviation. The code is similar, the resulting plot is as follows:
   ...
   \begin{center}
	\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_11_2_4.png}
\end{center}
...
So, on the 0-100 rank we obtain that the first principal  component explains 99.8\% of data scatter. The most contributing feature is IMDB\_Rating, which determines 96\% of the PC. 
...
None of these has really "linear-like" plot, but we choose Length\_Minutes and IMDB\_Rating as the best variant. First, explore closer their scatter-plot.

    \begin{center}
	\adjustimage{max size={0.7\linewidth}{0.9\paperheight}}{output_3_1_5.png}
\end{center}
...
requires a huge budget, which will be approved if the film is supposed to be good. So, long films are among the good ones.
...
The determinacy coefficient is 0.18600394479373705, which is very low value. At the same time mean absolute error is very high. It shows that the classificator works really bad on these features. 
